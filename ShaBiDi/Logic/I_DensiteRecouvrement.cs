...
namespace ShaBiDi.Logic
{
    public class I_DensiteRecouvrement : Indicateur
    {
        ...
        private void calculeDensite(ImageExp i, Dictionary<ImageExp, List<double[,]>> dico, List<Observation> listeObs)
        {
            ...
            double[,] pixelsImage = new double[ImageExp.dimensionsImageLignes, ImageExp.dimensionsImageCol];
        ...
        public Dictionary<ImageExp, double[,]> determineDensite()
        {
        ...
        public Dictionary<ImageExp, double[,]> compareDensite(TypeComp type, I_DensiteRecouvrement i)
        {
       ...
       // travailler, il faudraf faire des foreach pour balayer toutes les valeurs du travaux
        private Dictionary<ImageExp, double[,]> additionner(Dictionary<ImageExp, List<double[,]>> dico)
        {
            ...
            double[,] somme= new double[ImageExp.dimensionsImageLignes, ImageExp.dimensionsImageCol];
            ...
            foreach (ImageExp i in dico.Keys)
            {
                ...
                if (dico[i].Count == 2)
                {
                    for (int l = 0; l < ImageExp.dimensionsImageLignes; l++)
                    {
                        for (int c = 0; c < ImageExp.dimensionsImageCol; c++)
                        {
        ...
        private Dictionary<ImageExp, double[,]> soustraire(Dictionary<ImageExp, List<double[,]>> dico)
        {
            ...
            Dictionary<ImageExp, double[,]> dicoCompare = new Dictionary<ImageExp, double[,]>();
            double[,] dif = new double[ImageExp.dimensionsImageLignes, ImageExp.dimensionsImageCol];
        ...
        {
            Dictionary<ImageExp, double[,]> dicoCompare = new Dictionary<ImageExp, double[,]>();
            double[,] moy = new double[ImageExp.dimensionsImageLignes, ImageExp.dimensionsImageCol];
